 ...
 * @author maleeha
 */
public class U_address extends javax.swing.JFrame {

    /**
     * Creates new form U_address
     */
    public U_address() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("UPDATE ORGANIZATION ADDRESS");
        ...
        jLabel3.setText("UPDATED ADDRESS:");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        boolean b=o.adress(id,update);
        if(b==true)
        JOptionPane.showMessageDialog(null, "address for "+id+" is updated");
        else
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(U_address.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
