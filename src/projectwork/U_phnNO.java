 ...
 * @author maleeha
 */
public class U_phnNO extends javax.swing.JFrame {

    /**
     * Creates new form U_phnNO
     */
    public U_phnNO() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel2.setText("UPDATE ORGANIZATION PHONE NO");
        ...
        jLabel3.setText("UPDATE PHONE NO:");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String update=jTextField2.getText().toString();
        if(jTextField1.getText().isEmpty() ||jTextField2.getText().isEmpty())
        {
            JOptionPane.showMessageDialog(null, "feilds should not be empty");
        }
        else{
        boolean b=o.phone(id,update);
        if(b==true)
        JOptionPane.showMessageDialog(null, "PHONE NO OF ORGANIZATION "+id+" is updated");
        else
        JOptionPane.showMessageDialog(null, "ORGANIZATION ID IS NOT FOUND IN THE RECORDS");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(U_phnNO.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
